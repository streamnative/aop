...
@Slf4j
public class RedirectClientCnx extends ClientCnx {
    ...
    public RedirectClientCnx(ClientConfigurationData conf, EventLoopGroup eventLoopGroup, String clientAuthRole,
