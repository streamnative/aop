...
public class AmqpChannelMethodTest extends AmqpProtocolTestBase {
    ...
    public void testExchangeDelete() {
        ...
        AMQBody response1 = (AMQBody) clientChannel.poll(1, TimeUnit.SECONDS);
...
//        Assert.assertTrue(response instanceof BasicAckBody);
    ...
    public void testBasicAckOne() {
        ...
        unacknowledgedMessageMap.add(1, PositionFactory.create(1, 1), consumer, 0);
        unacknowledgedMessageMap.add(2, PositionFactory.create(1, 1), consumer, 0);
        unacknowledgedMessageMap.add(3, PositionFactory.create(1, 1), consumer, 0);
    ...
    public void testBasicAckBatch() {
        ...
        unacknowledgedMessageMap.add(2, PositionFactory.create(1, 1), consumer, 0);
        unacknowledgedMessageMap.add(3, PositionFactory.create(1, 1), consumer, 0);
        unacknowledgedMessageMap.add(4, PositionFactory.create(1, 1), consumer, 0);
