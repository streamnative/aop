...
public final class ChannelClose extends Channel {
    ...
    public ChannelClose(ByteBuf channelBuffer) {
    ...
    public ChannelClose(UnsignedShort replyCode, ShortString replyText,
                        UnsignedShort classId, UnsignedShort methodId) {
