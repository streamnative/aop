...
@Slf4j
public class RedirectConnectionPool extends ConnectionPool {
    public RedirectConnectionPool(ClientConfigurationData clientConfig, EventLoopGroup eventLoopGroup,
